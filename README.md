...
#22. What is the role of services in AngularJS and name any services made available by default?
 ...
 ###Overview:
  ...
  – [http://www.tutorialspoint.com/angularjs/angularjs_services.htm]   (http://www.tutorialspoint.com/angularjs/angularjs_services.htm)
...
For more information, feel free to check out the [AngularJS documentation].(https://docs.angularjs.org/guide/directive)
...
Sources: [https://docs.angularjs.org/api/ng/service/$compile#directive-definition-object](https://docs.angularjs.org/api/ng/service/$compile#directive-definition-object)
...
Source:
[https://github.com/daniellmb/angular-test-patterns/blob/master/patterns/filter.md](https://github.com/daniellmb/angular-test-patterns/blob/master/patterns/filter.md)
